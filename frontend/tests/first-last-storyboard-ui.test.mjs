...
test('storyboard workbench exposes first-last frame slots and generate actions', () => {
  ...
  assert.match(episode, /resolveFirstLastPromptRefs/)
  assert.match(episode, /first_last_prompt/)
  assert.match(episode, /firstLastMentionOptions/)
  assert.match(episode, /首尾帧视频提示词/)
  assert.match(episode, /@首帧/)
})
